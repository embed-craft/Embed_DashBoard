            ...
            <Tabs defaultValue="general" className="w-full">
                ...
                <TabsContent value="general" className="space-y-5 animate-in fade-in-50">
                    ...
                    <div className="space-y-4 border rounded-lg p-3 bg-gray-50/50">
                                ...
                                <Input
                                    ...
                                    value={
                                        typeof config.borderRadius === 'number'
                                            ? config.borderRadius
                                            : (config.borderRadius?.topLeft ?? 16)
                                    }
                                    onChange={(e) => {
                        ...
                        <p className="text-[10px] text-gray-400 mt-1">Radius is applied to top corners. Overflow determines if long content scrolls.</p>
                    </div>
                        ...
                        <div className="border rounded-lg p-3 space-y-3 bg-gray-50/50">
                            ...
                            <div className="flex items-center justify-between">
                                <Label className="text-xs text-gray-600 flex items-center gap-2">
                                    <ChevronDown className="w-3 h-3" /> Swipe Down to Close
                                </Label>
                                <Switch
