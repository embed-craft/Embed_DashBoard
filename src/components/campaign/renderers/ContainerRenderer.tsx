...
export const ContainerRenderer: React.FC<ContainerRendererProps> = ({
    ...
    const style: React.CSSProperties = {
        ...
        paddingLeft: safeScale((layer.style as any)?.paddingX || 0, scale),
        paddingRight: safeScale((layer.style as any)?.paddingX || 0, scale),
        paddingTop: safeScale((layer.style as any)?.paddingY || 0, scale),
        paddingBottom: safeScale((layer.style as any)?.paddingY || 0, scale),
