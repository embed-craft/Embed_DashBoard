            ...
            <div
                ...
                {backgroundUrl && (
                    <div style={{
                        ...
                        inset: 0,
                        zIndex: 1,
                        backgroundImage: backgroundUrl.startsWith('http') ? `url('${backgroundUrl}')` : `url('${import.meta.env.VITE_API_URL || (import.meta.env.PROD ? '' : 'http://localhost:4000')}${backgroundUrl}')`,
